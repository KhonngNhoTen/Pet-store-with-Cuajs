...
export type BeforeCreateRoute = (schema: InputRouteSchema, outSchenma: RouteSchema, wrapperSchema?: InputRouteSchema) => RouteSchema;
...
export declare function isIRoutePlugin(object: any): object is IRoutePlugin;
